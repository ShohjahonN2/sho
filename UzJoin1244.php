...
flush();
$API_KEY = '1544026937:AAHNYBttz2TkwnwuxHn0u1FHUfaV1Dem0RE';
...
[['text' => " Guruhga qo'shish",'url'=>"https://telegram.me/$mybot?startgroup=new"]],
   [['text' => "📣Kanalimiz",'url'=>"https://telegram.me/tarix_quiz1"]],
    [['text' => "👨💻 Admin",'url'=>"https://telegram.me/Shohjahon_N2"]]
    ]
])
        ]);
 bot('sendmessage', [
...
bot('sendmessage', [
            ...
            'text' => "<a href='tg://user?id=$from_id'>$name</a> Siz @tarix_quiz1 kanalimizga a'zo bo'lsangizgina,bu guruhda xabar yoza olasiz!",
				'parse_mode'=>'html',
            'reply_markup' =>  json_encode([
                'inline_keyboard' => [
    [['text' => "➕A'zo bo'lish",'url'=>"https://telegram.me/tarix_quiz1"]],
...
Namuna </b> @Xakkerlar_Pro kanalini Xakkerlar_Pro <b> deb yuborasiz!</b>

📣Kanalimiz @tarix_quiz1",
 'parse_mode'=>'html']);
} }
if($azidil == "sett"){
    if($rank == "creator" or $rank== "administrator"){
